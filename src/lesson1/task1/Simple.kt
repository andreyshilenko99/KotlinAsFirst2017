 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double =(((sagenes*3+arshins)/3.0*48+vershoks)*4.445)/100
 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = (grad+(min+(sec/60.0))/60.0)*3.141592/180
